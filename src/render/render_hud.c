...
/*   Updated: 2025/01/28 21:07:48 by madelvin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	put_cam_info(void *mlx, void *win, t_scene *scene)
{
...
void	render_hud(t_scene *scene)
{
	...
	put_cam_info(mlx, win, scene);
	put_param_info(mlx, win, scene);
